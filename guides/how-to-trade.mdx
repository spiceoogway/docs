...
In order to participate in a decision market, you need to enter a market with either SOL or the target token. In this walkthrough, we will give examples using `$ZC`, ZCombinator's native token, and `$SOL`.
